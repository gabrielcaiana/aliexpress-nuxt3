...
const isAccountMenu: Ref<boolean> = ref(false);
const isSearching: Ref<boolean> = ref(false);
const searchItem: Ref<string> = ref("");
const isCartHover: Ref<boolean> = ref(false);
</script>

<template>
  <div>
    <div id="MainLayout" class="w-full fixed z-50">
      <div id="TopMenu" class="w-full bg-neutral-200 border-b md:block hidden">
        <ul
          class="flex items-center justify-end m-auto text-xs text-[#] font-light px-2 h-10 bg-neutral-200 max-w-[1200px]"
        >
          <li
          ...
          >
            ...
            <div
              v-if="isAccountMenu"
              id="AccountMenu"
              class="absolute bg-white w-[220px] text-[#] z-40 top-[38px] -left-[100px] border-x border-b"
            >
              <div v-if="true">
          ...
          <div class="max-w-[700px] w-full md:block hidden">
            <div class="relative">
              ...
              >
                ...
                />
                <button
                  class="flex items-center h-[100%] p-1.5 px-2 bg-primary"
                >
                  <Icon
                ...
                <div v-if="false" class="p-1">
                  ...
                  >
                    <div class="flex items-center">
                      ...
                      />
                      <div class="truncate ml-2">Product name</div>
                    </div>
    ...
    <BaseFooter v-if="!userStore.isLoading" />
  </div>
</template>
