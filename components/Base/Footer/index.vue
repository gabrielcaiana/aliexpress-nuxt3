<template>
  <div id="FooterMain" class="w-full bg-neutral-300 mt-10 mb-2">
    <div class="max-w-[1200px] mx-auto px-4">
      <div class="md:flex gap-4 justify-between w-full">
        <div class="md:w-[50%] pt-4">
          <div class="text-lg font-semibold text-neutral-600">Help</div>
  ...
  <div id="FooterSub" class="w-full bg-neutral-300 text-sm text-gray-400">
